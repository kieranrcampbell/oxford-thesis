...
\begin{figure}
\centering
  \includegraphics[width=0.98\textwidth]{figures/shalek_thesis}
  ...
  \textbf{E} Example gene expression plots of some genes identified with differential interactions. Strikingly, \emph{Tnf} is upregulated under PAM exposure yet downregulated under LPS stimulation.}  \label{fig:shalek}
\end{figure}
