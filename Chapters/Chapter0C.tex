...
where $\by_i$ is a $G$-length vector of expression in cell $i$, $B$ is the number of branches modelled and we define $\Lambda_\gamma = [ \bc_\gamma \; \bk_\gamma], \; \gamma \in 1, \ldots, B$.
