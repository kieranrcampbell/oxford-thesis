%************************************************
\chapter{Modelling bifurcations with Bayesian mixtures of factor analysers}\label{ch:mfachap} % $\mathbb{ZNR}$
%************************************************
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{gfx/ch4/s1_dropout}
...
\begin{equation}
p(\text{dropout in gene $g$}) = \exp(-\lambda \sum_{i=1}^N x_{ig})
\end{equation}
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.9\textwidth]{gfx/ch4/bifurcation_solutions}
...
\begin{figure}
	...
	\caption{Generation of synthetic data} \label{fig:mfa_synthetic}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.85\textwidth]{gfx/ch4/fig1_toy}
...
\begin{figure}
	\centering
	\includegraphics[width=.9\textwidth]{gfx/ch4/dropout}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth]{gfx/ch4/limits_of_chi}
